...
public class RepastRunner extends AbstractRunner{
	private static MessageCenter msgCenter = MessageCenter.getMessageCenter(RepastRunner.class);
	...
	public void initializeSchedules(String message) {
		ScheduleParameters param = ScheduleParameters.createRepeating(1, 2);
		getSchedule().schedule(param, new Distribution(), "step", message);
	}
}
